...
function UserGrid() {
  ...
  return (
    <>
      {
        loading
          ? <CircularProgress sx={{marginLeft:'auto', marginRight:'auto', marginTop:'200px'}} size={100}/>
          : <>
              <Grid
                container
              ...
              </Grid>
              {
                totalCount === 0
                  ? null
                  : <Pagination sx={{margin:'auto'}} page={currentPage} count={totalPageCount} color='primary' onChange={handleChangePage} />
              }
            </>
      }
    </>
